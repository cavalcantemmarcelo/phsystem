...
const faqData = {
  qas: [
    ...
    {
      question: "Quem somos?",
      answer: "Uma breve descrição de sua empresa e sua expertise na indústria."
    },
  ],
...
const authorData = {
  ...
  teacherDescription: 'Uma breve descrição de sua empresa e sua dedicação à qualidade e inovação.',
  ...
  sections: [
    {
      ...
      description: "Como seu produto oferece precisão e confiabilidade incomparáveis."
    },
    {
      iconClass: "fas fa-wrench",
      title: "Fácil de Usar",
      description: "Como seu produto é projetado para facilitar o uso e garantir testes fáceis."
    },
    {
      iconClass: "fas fa-cogs",
      iconColor: "text-primary",
      title: "Resultados Rápidos",
      description: "Como seu produto oferece resultados de teste rápidos e precisos."
    },
  ],
...
const toolsData = {
  ...
  paragraphs: [
    ...
    },
    {
      ...
      description: 'Destaque o suporte técnico e assistência que sua empresa oferece.'
    },
  ],
  ctaLink: ctaLinkDefault,
  ctaText: 'Peça o seu produto hoje',
